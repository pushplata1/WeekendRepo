...
WebUI.rightClick(findTestObject('Object Repository/Page_JPetStore Demo/td_EST-1'))

WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/div_Shopping CartItem IDProduct IDDescripti_f30008'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_JPetStore Demo/a_EST-1'), 'EST-1')
