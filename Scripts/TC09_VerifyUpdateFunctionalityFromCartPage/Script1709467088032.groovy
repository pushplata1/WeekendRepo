...
WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/sizeTextBox'), '5')
...
WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/a_K9-DL-01'))

WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/a_Add to Cart_1'))

WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/sizeTextBox'), '3')
