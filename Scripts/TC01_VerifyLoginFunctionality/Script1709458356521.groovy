...
WebUI.verifyElementText(findTestObject('Object Repository/Page_JPetStore Demo/a_Sign In'), 'Sign In')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_JPetStore Demo/div_Welcome Pushp'), 'Welcome Pushp!')
