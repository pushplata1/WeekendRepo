...
WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/a_FI-SW-02'))
...
WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/a_FI-FW-02'))

WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/a_Add to Cart_1_2'))

WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/a_Return to Main Menu'))

WebUI.click(findTestObject('Object Repository/CatImg'))

WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/a_FL-DLH-02'))

WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/a_Add to Cart_1_2_3'))
