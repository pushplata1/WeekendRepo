...
WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/FirstName'), 'Sagar')

WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/LastName'), 'Kumar')

WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/Address1'), 'Uttam Nagar')

WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/Zip'), '110059')
