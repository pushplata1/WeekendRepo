...
WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/searchText'), 'Fish')

WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/searchButton'))

WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/font_FI-FW-02'))
